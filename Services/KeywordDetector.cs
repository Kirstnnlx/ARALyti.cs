...
namespace ARALyti.cs.Services
{
    ...
    internal class TopicCollector : CSharpSyntaxWalker
    {
        ...
        private readonly HashSet<string> _detectedCollections = new(); // to avoid duplicate collection points

        // Helper: adds points to a topic, never exceeds cap (default 100)
        ...
        public override void VisitClassDeclaration(ClassDeclarationSyntax node)
        {
            ...
            Add("Object-Oriented Programming", 25); // base OOP points even without inheritance
        ...
        {
            // ignore "throw new Exception" – that belongs to exception handling
        ...
        public override void VisitInterfaceDeclaration(InterfaceDeclarationSyntax node)
        {
            ...
            Add("Inheritance", 100); // implementing an interface also counts as inheritance
        ...
        public override void VisitGenericName(GenericNameSyntax node)
        {
            ...
            if (CollectionTypes.Contains(typeName) && !_detectedCollections.Contains(typeName))
            {
                ...
                Add("Collections", 35); // points per unique collection type
            }
